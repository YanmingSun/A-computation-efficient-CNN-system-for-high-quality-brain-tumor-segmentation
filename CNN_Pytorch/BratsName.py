class Brats_Path_ID:
    def __init__(self):
        self.path_training_cases = '/project/XXXXXXX/XXX/MyBrats/Brats2019/MICCAI_BraTS_2019_Data_Training/'
        self.path_validation_cases = '/project/XXXXXXX/XXX/MyBrats/Brats2019/MICCAI_BraTS_2019_Data_Validation/'

        self.path_roi_training = '/None/'
        self.path_roi_validation = '/None/'
